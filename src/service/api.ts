...
// import { checkIsLightClient, connectApi } from "./polkadot/connectApi";
// import {
//   endpointKey,
//   getProviderIndex,
//   providerEndpoints,
...
//   const { NETWORK_IDX, SELECTED_ENDPOINT, SELECTED_ADDRESS, SELECTED_WALLET } =
//     LOCAL_STORAGE;
...
// //     const endpointsWithoutLightClient = providerEndpoints[
// //       networkIdx.value
// //     ].endpoints.filter((it) => !checkIsLightClient(it.endpoint));
...
//   const selectedEndpoint = selectedEndpointData
//     ? JSON.parse(selectedEndpointData)
//     : {};
//   if (networkIdxStore) {
...
//     providerEndpoints[Number(networkIdx.value)].networkAlias
//   );
//   useMeta({
//     title: "",
//     titleTemplate: (title) =>
//       `${title} | ${networkName} Portal - ${displayName}`,
//     htmlAttr: { lang: "en" },
//     link: {
//       material: {
//         rel: "icon",
...
//     if (!web3) {
//       console.error(
//         `cannot create the web3 instance with network id ${networkId}`
//       );
//     }
//     $web3.value = web3;
//   };
...
//     const isZkEvm =
//       networkIdx === endpointKey.ZKYOTO ||
//       networkIdx === endpointKey.ASTAR_ZKEVM;
