...
// export const checkIsLightClient = (endpoint: string): boolean =>
//   endpoint.startsWith("light://");
...
//   const filteredEndpoints = providerEndpoints[networkIdx].endpoints.filter(
//     (it) => {
...
//         console.error("handle disconnect")
//       );
