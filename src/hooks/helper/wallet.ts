...
//   const selectedAddress = "12F6tAQXjpkjH3SrxTeDM58c3rmQoJsNeiiq8ERVM6xKJDtG";
//   if (selectedAddress != null || forceRequest) {
//     let extensions = await web3Enable("MandalaNetwork/mandala-hub");
...
// //   async (): Promise<IWcEthereumProvider> => {
...
// //       await wait(2000);
// //       container.addConstant<typeof WcEthereumProvider>(
// //         Symbols.WcProvider,
// //         provider
// //       );
...
// //   walletName: SupportWallet
// // ): EthereumProvider | null => {
// //   if (walletName === SupportWallet.WalletConnect) {
// //     return getWcProvider();
// //   }
// //   const wallet =
// //     supportEvmWalletObj[walletName as keyof typeof supportEvmWalletObj];
// //   const provider = wallet
// //     ? (get(window, wallet.ethExtension) as EthereumProvider)
// //     : undefined;
// //   const isExtension =
// //     wallet &&
// //     walletName === wallet.source &&
